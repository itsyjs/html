...
- Delete a closing tag and see which code you get, and what the message says the browser would do.
...
- Write a `<style>` block and style your own markup. The preview renders in a shadow root, so it
  starts from the browser's own stylesheet rather than this site's, and what you write there cannot
